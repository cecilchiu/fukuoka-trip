...
export const CHECKLIST_DATA: ChecklistCategory[] = [
  ...
  // 6. Gemini Service (修正 import.meta.env 與型別)
  'src/services/gemini.ts': `import { GoogleGenAI, GenerateContentResponse } from "@google/genai";
...
try {
  ...
  console.log('✅ 檔案更新完畢！請執行以下指令完成部署：');
  console.log('1. git add .');
  console.log('2. git commit -m "Fix typescript errors"');
